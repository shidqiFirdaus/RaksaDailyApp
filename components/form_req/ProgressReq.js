...
export default  main_program=({route, navigation})=>{
  ...
  get_data =()=> {
    try {
      axios.post('url/prog-x/api/form_req/api_list_progress_approval_v2.php', {
      ...
      <View style={styles.containerDataUser}>
        <Header 
              ...
              <View style={{ justifyContent: 'center',alignItems : 'center'}}>
                <Text style={{ fontSize: 20, fontWeight: 'bold', marginTop: 5 ,color:'#000000' }}>Progress Request </Text>
              </View>
              <View>
