...
export default  main_program=({route, navigation})=>{
  ...
  let [dept_lengkap, setdept_lengkap]    = useState(route.params.dept);
  ...
  konfirmasiLogout = () => {
    ...
    return (
       ...
       <Image
            ...
            <Text style = { styles.header }>Detail Permintaan Kartu Nama</Text>
            ...
            <CardItem>
                {/* <Item> */}
                <Text style = { styles.tulisan_detail }>Departemen/Cabang : {dept_lengkap}</Text>
                {/* </Item> */}
            </CardItem>
            <CardItem>
                {/* <Item> */}
            ...
            <CardItem>
                {/* <Item> */}
                    <Text style = { styles.tulisan_detail }>Status : {status}</Text>
                {/* </Item> */}
            </CardItem>
