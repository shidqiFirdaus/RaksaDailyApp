...
let [bulan, setbulan]                              = useState(route.params.bulan);
let [periode_awal, setperiode_awal]              = useState(route.params.periode_awal);
let [id_req, setid_req]                            = useState(route.params.kode_karyawan_req);
let [periode_akhir, setperiode_akhir]                                = useState(route.params.periode_akhir);
...
let [no_skpd, setno_skpd]                  = useState(route.params.no_skpd);
let [nsr, setnsr]          = useState(route.params.nsr);
let [total_hari, settotal_hari]                    = useState(route.params.total_hari);
let [tarif_pajak, settarif_pajak]                    = useState(route.params.tarif_pajak);
let [isi_teks, setisi_teks]                    = useState(route.params.isi_teks_pajak);
let [jumlah_nilai, setjumlah_nilai]                    = useState(route.params.jumlah_nilai_pajak);
let [luas, setluas]                    = useState(route.params.luas_reklame);
  ...
  Action_Approve = () =>
  {
        axios.post("https://www.araksa.com/prog-x/api/form_req/api_action_grab.php", {
  ...
  konfirmasiLogout = () => {
    ...
    return (
       ...
       <Image
            ...
            <Text style = { styles.header }>Detail Request Pembayaran Pajak Reklame</Text>
            ...
            <CardItem>
                {/* <Item> */}
                    <Text style = { styles.tulisan_detail }>Bulan : {bulan}</Text>
                {/* </Item> */}
            </CardItem>
            <CardItem>
                {/* <Item> */}
                    <Text style = { styles.tulisan_detail }>Periode Awal Pajak : {periode_awal}</Text>
                {/* </Item> */}
            </CardItem>
            <CardItem>
                {/* <Item> */}
                    <Text style = { styles.tulisan_detail }>Periode Akhir Pajak : {periode_akhir}</Text>
                {/* </Item> */}
            </CardItem>
            <CardItem>
                {/* <Item> */}
            ...
            <CardItem>
                {/* <Item> */}
                    <Text style = { styles.tulisan_detail }>No. SKPD : {no_skpd}</Text>
                {/* </Item> */}
            </CardItem>
            <CardItem>
                {/* <Item> */}
                    <Text style = { styles.tulisan_detail }>Isi Teks Pajak Reklame : {isi_teks}</Text>
                {/* </Item> */}
            </CardItem>
            <CardItem>
                {/* <Item> */}
                    <Text style = { styles.tulisan_detail }>Luas Reklame (m2): {luas}</Text>
                {/* </Item> */}
            </CardItem>
            <CardItem>
                {/* <Item> */}
                    <Text style = { styles.tulisan_detail }>NSR: {nsr}</Text>
                {/* </Item> */}
            </CardItem>
            <CardItem>
                {/* <Item> */}
                    <Text style = { styles.tulisan_detail }>Tarif Pajak : {tarif_pajak}</Text>
                {/* </Item> */}
            </CardItem>
            <CardItem>
                {/* <Item> */}
                    <Text style = { styles.tulisan_detail }>Jumlah Nilai Pajak : {jumlah_nilai}</Text>
                {/* </Item> */}
            </CardItem>
            <CardItem>
                {/* <Item> */}
