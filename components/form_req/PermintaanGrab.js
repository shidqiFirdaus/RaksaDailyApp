...
//insert data 
  api_insert_data = () => 
  {
    ...
    axios.post("url/prog-x/api/form_req/api_insert_permintaan_grab.php", {
    ...
    .catch(function (error) {
      ...
      console.log(responseJson.data);
        ...
        return (
            ...
            <Text style = { styles.header }>Pendaftaran Member Grab Corporate</Text>
            ...
            <CardItem bordered="true">
              <Text style={{color: 'black'}}>No. ID Karyawan : {nik}</Text>
            </CardItem>
            ...
            <CardItem bordered="true">
              ...
              {/* </Body> */}
              <Label style={{marginBottom:5, fontSize:15, color:'black'}}>E-mail yang terdaftar di Grab :</Label>


              <TextInput
                    style={{ width:150, borderBottomWidth: 1, borderBottomColor: 'black',color: '#000000'}}
            ...
            <CardItem bordered="true">
              ...
              {/* </Body> */}
              <Label style={{marginBottom:5, fontSize:15, color:'black'}}>No. Telp yang terdaftar di Grab :</Label>
