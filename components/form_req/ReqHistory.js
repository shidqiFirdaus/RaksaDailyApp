...
export default  main_program=({route, navigation})=>{
  ...
  get_data =()=> {
    console.log("Tipe Form: "+kode_form);
    try {
      axios.post('url/prog-x/api/form_req/api_list_data_v2.php', {
        ...
        <View>
          ...
          onPress={ async() => {
            ...
            if(kode_form == 'KNAMA')
            {
              ...
              navigation.navigate("Detail_History", item)
            }
            if(kode_form == 'STATION')
            {
              ...
              await setpil_form("");
              await setjson_view_data("");
              navigation.navigate("DetailStation", item)
            }
            if(kode_form == 'GRAB')
            {
              await setjson_form("");
              ...
              await setpil_form("");
              await setjson_view_data("");
              navigation.navigate("DetailGrab", item)
            }
            if(kode_form == 'TIPS')
            {
              await setjson_form("");
              ...
              await setpil_form("");
              await setjson_view_data("");
              await navigation.replace("DetailTips", item)
            ...
            if(kode_form == 'REKLAME')
            {
              ...
              await setpil_form("");
              await setjson_view_data("");
              await navigation.replace("DetailPajak", item)
                  ...
                  <Content>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <View style={{ flex: 3}}>
                        ...
                        <Text style={{ fontSize: 12, fontWeight: 'bold', marginTop: 5,color:'#000000' }}>Status: {item.status}</Text>
        ...
        <Header 
              ...
              >
               ...
               <View style={{ justifyContent: 'center',alignItems : 'center'}}>
                <Text style={{ fontSize: 20, fontWeight: 'bold', marginTop: 5 ,color:'#000000' }}>Request History </Text>
                <View>
