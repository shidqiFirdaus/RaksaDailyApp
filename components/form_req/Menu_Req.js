...
export default main_program = ({route, navigation}) => {
  ...
  Req_Form = () => {
    navigation.navigate('Pilih_Form');
  };

  History = () => {
    navigation.navigate('Req_History');
  };

  ProgressReq = () => {
    navigation.navigate('ProgressReq');
  };
  ...
  AwaitingList = () => {
    navigation.navigate('IncomingApproval');
  ...
  return (
    <View style={styles.container}>
      <Header
        ...
        <Body></Body>
        <Right>
          <TouchableOpacity onPress={this.konfirmasiLogout} activeOpacity={0.5}>
            <Image
              style={{
                width: 30,
                height: 40,
      ...
      <View style={styles.containerTengah}>
        ...
        <View style={styles.menu1}>
          <View style={styles.pilihan1}>
            <View>
              ...
              <View>
                <Text style={styles.textMenu1}>Request Form</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.pilihan2}>
            <View>
              <TouchableOpacity activeOpacity={1} onPress={this.AwaitingList}>
                <View style={styles.menuInput}>
                  <FontAwesomeIcon
                    // size={24} color={'rgba(67, 37, 119,0.7)'}
                    size={75}
            ...
            <View>
              <Text style={styles.textMenu2}>Incoming Request</Text>
            </View>
          </View>
        </View>
        <View style={styles.menu2}>
          <View style={styles.pilihan3}>
            <View>
              <TouchableOpacity activeOpacity={1} onPress={this.History}>
                <View style={styles.menuInput}>
                  <FontAwesomeIcon
                    size={75}
                    color={'rgba(28,53,101,255)'}
            ...
            <View>
              <Text style={styles.textMenu3}>History</Text>
            </View>
          </View>
          <View style={styles.pilihan4}>
            <View>
              <TouchableOpacity activeOpacity={1} onPress={this.ProgressReq}>
                <View style={styles.menuInput}>
                  <FontAwesomeIcon
                    // size={24} color={'rgba(67, 37, 119,0.7)'}
                    size={75}
            ...
            <View>
              <Text style={styles.textMenu4}>Progress Request</Text>
            </View>
          </View>
        </View>
        <View style={styles.menu2}>
          <View style={styles.pilihan3}>
            ...
            <View>
              <Text style={styles.textMenu3}>E Document</Text>
            </View>
          </View>
        </View>
      </View>
